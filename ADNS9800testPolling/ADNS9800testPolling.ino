// provided from https://github.com/mrjohnk/ADNS-9800
...
const int ncs = 10;
int absX = 0;    // absolute X position
int absY = 0;    // absolute Y position
...
int convTwosComp(int b){
  ...
  if(currTime > pollTimer){
    UpdatePointer();
    xydat[0] = convTwosComp(xydat[0]) * 0.1;
    xydat[1] = convTwosComp(xydat[1]) * 0.1;
    absX = absX + xydat[0];
    absY = absY + xydat[1];
